...
class _TripCreationScreenState extends State<TripCreationScreen> {
  ...
  Future<void> _generateAndSaveTrip() async {
    ...
    if (destination.isEmpty || _startDate == null || _endDate == null || budget.isEmpty || people.isEmpty) {
...
''';
    ...
    try {
      ...
      setState(() {
        _generatedItinerary = itinerary.replaceAll('#', '').replaceAll('*', '');
        _isLoading = false;
      });
      _showItineraryPreviewDialog(_generatedItinerary!);
    } catch (e) {
